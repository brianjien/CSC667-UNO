...
var alterPolicy_exports = {};
__export(alterPolicy_exports, {
  alterPolicy: () => alterPolicy
});
module.exports = __toCommonJS(alterPolicy_exports);
var import_shared = require("./shared");
function alterPolicy(mOptions) {
  const _alter = (tableName, policyName, options = {}) => {
    const clausesStr = (0, import_shared.makeClauses)(options).join(" ");
